    ...
    <div className="relative z-10">
      ...
      <div className="max-w-7xl mx-auto px-6 py-24">
        ...
        >
          ...
          <h3 className="text-5xl font-black text-nature-dark tracking-tighter uppercase mb-4">Find Us In <span className="text-primary">Punjab</span></h3>
          <p className="text-gray-400 font-medium max-w-2xl mx-auto">Discover the heart of our operations where nature's finest grains are nurtured and harvested.</p>
        </motion.div>
        ...
        >
          ...
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1746.42587635!2d75.3412!3d31.1471!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391964aa569e7355%3A0x8fbd26e123456789!2sPunjab!5e0!3m2!1sen!2sin!4v1715690000000!5m2!1sen!2sin" 
            width="100%" 
            height="100%" 
